...
function(generate_lvgl_indexed_images header_filename) 
  cmake_parse_arguments(GENERATE_LVGL_INDEXED_IMAGES "" "ROTATE;INVERT;NAME" "IMAGES" ${ARGN})
  set(GENERATED_FILE ${CMAKE_CURRENT_BINARY_DIR}/${header_filename})
  ...
  if(GENERATE_LVGL_INDEXED_IMAGES_NAME)
    list(APPEND GENERATE_LVGL_INDEXED_IMAGES_PY_ARGS "--name" ${GENERATE_LVGL_INDEXED_IMAGES_NAME})
  endif()
  add_custom_command(
